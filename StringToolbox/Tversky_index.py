...
class TI(MethodModel):
    '''
    This class is used to calculate the tversky index between strings.
    The tversky index measures the similarity of the substrings components
    of the two strings.
    ...
    '''
    def __init__(self, n = 1, alpha = 0.5, beta = 2):
    ...
    def calculator(self, string1, string2):
        ...
        length1 = len(n_gram1)-length_common
        length2 = len(n_gram2)-length_common
